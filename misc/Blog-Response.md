...
For those of you who don't like TypeScript for whatever reason, that's also fine. A ton of great mods have been made in Lua. While it has some disadvantages, there's nothing wrong with using Lua. Jill recommends a lot of great Lua tools in her blog that I use myself in my own Lua projects. EmmyLua and Luacheck are really nice, so check those out if you already haven't - they can partially make up for some of these disadvantages.
