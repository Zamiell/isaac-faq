...
It's worth noting that if you use [IsaacScript](https://isaacscript.github.io/), you can avoid dealing with any of this since you can easily leverage the well-tested save data manager this is included in the standard library.
