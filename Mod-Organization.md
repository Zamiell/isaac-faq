...
Here, the author of file 2 figured that all he was doing was charging item 1. But surprise! Unbeknownst to them, simply by requiring the file, it executed other code, and it affected item 3.
